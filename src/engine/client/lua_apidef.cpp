...
void CLuaFile::RegisterLuaCallbacks(lua_State *L) // LUABRIDGE!
{
	...
	getGlobalNamespace(L)
		...
		.beginClass< IGraphics::CQuadItem >("QuadItem")
			.addConstructor <void (*) (float, float, float, float)> ()
			.addData("x", &IGraphics::CQuadItem::m_X)
			.addData("y", &IGraphics::CQuadItem::m_Y)
			.addData("w", &IGraphics::CQuadItem::m_Width)
			.addData("h", &IGraphics::CQuadItem::m_Height)
		.endClass()

		.beginClass< IGraphics::CFreeformItem >("FreeformItem")
			.addConstructor <void (*) (float, float, float, float, float, float, float, float)> ()
			.addData("x1", &IGraphics::CFreeformItem::m_X0)
			.addData("y1", &IGraphics::CFreeformItem::m_Y0)
			.addData("x2", &IGraphics::CFreeformItem::m_X1)
			.addData("y2", &IGraphics::CFreeformItem::m_Y1)
			.addData("x3", &IGraphics::CFreeformItem::m_X2)
			.addData("y3", &IGraphics::CFreeformItem::m_Y2)
			.addData("x4", &IGraphics::CFreeformItem::m_X3)
			.addData("y4", &IGraphics::CFreeformItem::m_Y3)
		.endClass()

		.beginClass< IGraphics::CLineItem >("LineItem")
			.addConstructor <void (*) (float, float, float, float)> ()
			.addData("x1", &IGraphics::CLineItem::m_X0)
			.addData("y1", &IGraphics::CLineItem::m_Y0)
			.addData("x2", &IGraphics::CLineItem::m_X1)
			.addData("y2", &IGraphics::CLineItem::m_Y1)
		.endClass()

		.beginClass< IGraphics::CColorVertex >("ColorVertex")
			.addConstructor <void (*) (float, float, float, float, float)> ()
			.addData("Index", &IGraphics::CColorVertex::m_Index)
			.addData("r", &IGraphics::CColorVertex::m_R)
			.addData("g", &IGraphics::CColorVertex::m_G)
			.addData("b", &IGraphics::CColorVertex::m_B)
			.addData("a", &IGraphics::CColorVertex::m_A)
		.endClass()
		...
		.beginClass<ISound>("ISound")
			...
			.addFunction("LoadSoundWave", &ISound::LoadWVLua)
			.addFunction("LoadSoundOpus", &ISound::LoadOpusLua)
			//.addFunction("LoadSoundWaveMemory", &ISound::LoadWVFromMem)
			//.addFunction("LoadSoundOpusMemory", &ISound::LoadOpusFromMem)
			.addFunction("UnloadSound", &ISound::UnloadSampleLua)
...
#undef MACRO_TUNING_PARAM
		...
		.beginClass<IGraphics>("IGraphics")
			...
			.addFunction("QuadsDrawFreeform", &IGraphics::QuadsDrawFreeformLua)
			...
			.addFunction("SetColorVertex", &IGraphics::SetColorVertexLua)
			...
			.addFunction("LoadTexture", &IGraphics::LoadTextureLua)
			.addFunction("LoadTextureSimple", &IGraphics::LoadTextureLuaSimple)
			.addFunction("UnloadTexture", &IGraphics::UnloadTextureLua)
